...
//		print(projectileParticleName);
	...
	public void getProjectileNames()			// Find and diplay the name of the nowly selected projectile
	{
		// Access the nowly selected projectile's 'ProjectileScript'
		projectileScript = effectScript.projectiles[effectScript.nowProjectile].GetComponent<ETFXProjectileScript>();
		projectileParticleName = projectileScript.projectileParticle.name;	// Assign the name of the nowly selected projectile to projectileParticleName
	}
