...
public class UICanvasManager : MonoBehaviour {
	...
	void Start () {
		if (PENameText != null)
			PENameText.text = ParticleEffectsLibrary.GlobalAccess.GetnowPENameString();
	}
	...
	void Update () {
		...
		if (!MouseOverButton) {
			...
			if (Input.GetMouseButtonUp (0)) {
				// Spawn nowly Selected Particle System
				SpawnnowParticleEffect();
			}
		}
	...
	private void SpawnnowParticleEffect() {
