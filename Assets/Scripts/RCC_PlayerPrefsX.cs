...
public class RCC_PlayerPrefsX {
    ...
    public static string FormatCurrency(long value)
    {
        ...
        {
            // Show in billions with "Billions"
            double billions = value / 1_000_000_000.0;
            return billions.ToString("0.#") + " Billions";
        }
        else
        {
            // Show in trillions with "Trillion"
            double trillions = value / 1_000_000_000_000.0;
            return trillions.ToString("0.#") + " Trillion";
        }
    }
}